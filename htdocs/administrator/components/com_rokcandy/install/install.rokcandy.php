...
$plg_return = rok_plugin_install($this, "rokcandy_system", "System - RokCandy", "system", $rok_database);
$rok_install_status['RokCandy System Plugin'] = $plg_return;
// if ($plg_return->status == $plg_return->STATUS_FAIL) {
//     var_dump ($plg_return);
// }

$plg_return = rok_plugin_install($this, "rokcandy_button", "Button - RokCandy", "editors-xtd", $rok_database);
